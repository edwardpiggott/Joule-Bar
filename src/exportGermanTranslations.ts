...
// Generate German translations export for editing
function exportGermanTranslations(): string {
  const lines: string[] = [];
...
// Generate and log the CSV
const csvContent = exportGermanTranslations();
console.log(csvContent);
console.log('\n\n=== GERMAN TRANSLATIONS EXPORT COMPLETE ===');
console.log('Total lines:', csvContent.split('\n').length);
console.log('\nTo use this file:');
console.log('1. Copy the output above');
console.log('2. Save it as "german_translations.csv"');
console.log('3. Open in Excel and edit the "German Translation" column');
console.log('4. Save and send back for import');
