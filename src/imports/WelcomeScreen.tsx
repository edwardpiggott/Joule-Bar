import svgPaths from "./svg-wbxcjjkz1r";
...
function JouleAnimatedText() {
  const helpTexts = ['help', 'assist', 'guide', 'support', 'serve'];
  ...
  return (
    <div className="absolute bottom-[50.63%] content-stretch flex gap-[10px] items-center justify-center left-[-0.13px] top-[11.39%]" data-name="joule animated text">
      ...
      <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0 w-[120px]" data-name="joule text animation">
